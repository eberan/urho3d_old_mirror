...
uniform float4x4 cSpotProj : register(C11);
uniform float4x4 cViewProj : register(C15);
uniform float4 cUOffset : register(C19);
uniform float4 cVOffset : register(C20);
uniform float3 cViewRightVector : register(C21);
uniform float3 cViewUpVector : register(C22);
uniform float4x3 cSkinMatrices[64] : register(C23);
